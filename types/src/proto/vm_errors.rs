...
pub struct Aborted {
    // message fields
    pub aborted_error_code: u64,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}

impl<'a> ::std::default::Default for &'a Aborted {
    fn default() -> &'a Aborted {
        <Aborted as ::protobuf::Message>::default_instance()
    }
}
...
impl Aborted {
    ...
    pub fn get_aborted_error_code(&self) -> u64 {
        self.aborted_error_code
    }
    pub fn clear_aborted_error_code(&mut self) {
        self.aborted_error_code = 0;
    }

    // Param is passed by value, moved
    pub fn set_aborted_error_code(&mut self, v: u64) {
        self.aborted_error_code = v;
    }
}

impl ::protobuf::Message for Aborted {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if self.aborted_error_code != 0 {
            my_size += ::protobuf::rt::value_size(1, self.aborted_error_code, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        if self.aborted_error_code != 0 {
            os.write_uint64(1, self.aborted_error_code)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "aborted_error_code",
                    |m: &Aborted| { &m.aborted_error_code },
                    |m: &mut Aborted| { &mut m.aborted_error_code },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<Aborted>(
                    "Aborted",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static Aborted {
        static mut instance: ::protobuf::lazy::Lazy<Aborted> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const Aborted,
        };
        unsafe {
            instance.get(Aborted::new)
        }
    }
}

impl ::protobuf::Clear for Aborted {
    fn clear(&mut self) {
        self.aborted_error_code = 0;
        self.unknown_fields.clear();
    }
...
impl ::protobuf::reflect::ProtobufValue for Aborted {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
impl ExecutionStatus {
    ...
    pub fn get_aborted(&self) -> &Aborted {
        match self.execution_status {
            ::std::option::Option::Some(ExecutionStatus_oneof_execution_status::aborted(ref v)) => v,
            _ => Aborted::default_instance(),
        }
    }
    ...
    pub fn has_aborted(&self) -> bool {
        match self.execution_status {
            ::std::option::Option::Some(ExecutionStatus_oneof_execution_status::aborted(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_aborted(&mut self, v: Aborted) {
        self.execution_status = ::std::option::Option::Some(ExecutionStatus_oneof_execution_status::aborted(v))
    }

    // Mutable pointer to the field.
    pub fn mut_aborted(&mut self) -> &mut Aborted {
        if let ::std::option::Option::Some(ExecutionStatus_oneof_execution_status::aborted(_)) = self.execution_status {
        } else {
            self.execution_status = ::std::option::Option::Some(ExecutionStatus_oneof_execution_status::aborted(Aborted::new()));
        }
        match self.execution_status {
            ::std::option::Option::Some(ExecutionStatus_oneof_execution_status::aborted(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_aborted(&mut self) -> Aborted {
        if self.has_aborted() {
            match self.execution_status.take() {
                ::std::option::Option::Some(ExecutionStatus_oneof_execution_status::aborted(v)) => v,
                _ => panic!(),
            }
        } else {
            Aborted::new()
...
impl ::protobuf::Message for ExecutionStatus {
    fn is_initialized(&self) -> bool {
        if let Some(ExecutionStatus_oneof_execution_status::aborted(ref v)) = self.execution_status {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ...
                    self.execution_status = ::std::option::Option::Some(ExecutionStatus_oneof_execution_status::aborted(is.read_message()?));
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.execution_status {
            match v {
                ...
                &ExecutionStatus_oneof_execution_status::aborted(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, Aborted>(
                    "aborted",
                    ExecutionStatus::has_aborted,
                    ExecutionStatus::get_aborted,
                ));
...
impl ::protobuf::ProtobufEnum for VMVerificationErrorKind {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<VMVerificationErrorKind> {
        match value {
            ...
            26 => ::std::option::Option::Some(VMVerificationErrorKind::AbortTypeMismatchError),
    ...
    fn values() -> &'static [Self] {
        static values: &'static [VMVerificationErrorKind] = &[
            ...
            VMVerificationErrorKind::AbortTypeMismatchError,
...
impl ::protobuf::ProtobufEnum for VMInvariantViolationError {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<VMInvariantViolationError> {
        match value {
            ...
            9 => ::std::option::Option::Some(VMInvariantViolationError::InternalTypeError),
            _ => ::std::option::Option::None
        }
    }
    ...
    fn values() -> &'static [Self] {
        static values: &'static [VMInvariantViolationError] = &[
            ...
            VMInvariantViolationError::InternalTypeError,
        ];
        values
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x10\0\x12\n\n\x06MODULE\x10\x01\x12\x0e\n\nDEPENDENCY\x10\x02\"7\n\x07A\
    borted\x12,\n\x12aborted_error_code\x18\x01\x20\x01(\x04R\x10abortedErro\
    rCode\"\xc0\x01\n\x0fArithmeticError\x12I\n\nerror_code\x18\x01\x20\x01(\
    \x0e2*.types.ArithmeticError.ArithmeticErrorTypeR\terrorCode\"b\n\x13Ari\
    thmeticErrorType\x12\x1a\n\x16UnknownArithmeticError\x10\0\x12\r\n\tUnde\
    rflow\x10\x01\x12\x0c\n\x08Overflow\x10\x02\x12\x12\n\x0eDivisionByZero\
    \x10\x03\"\x9a\x02\n\x15DynamicReferenceError\x12U\n\nerror_code\x18\x01\
    \x20\x01(\x0e26.types.DynamicReferenceError.DynamicReferenceErrorTypeR\t\
    errorCode\"\xa9\x01\n\x19DynamicReferenceErrorType\x12\x20\n\x1cUnknownD\
    ynamicReferenceError\x10\0\x12\x1a\n\x16MoveOfBorrowedResource\x10\x01\
    \x12\x1c\n\x18GlobalRefAlreadyReleased\x10\x02\x12\x15\n\x11MissingRelea\
    seRef\x10\x03\x12\x19\n\x15GlobalAlreadyBorrowed\x10\x04\"\x9e\x02\n\x0f\
    ExecutionStatus\x12=\n\x0eruntime_status\x18\x01\x20\x01(\x0e2\x14.types\
    .RuntimeStatusH\0R\rruntimeStatus\x12*\n\x07aborted\x18\x02\x20\x01(\x0b\
    2\x0e.types.AbortedH\0R\x07aborted\x12C\n\x10arithmetic_error\x18\x03\
    \x20\x01(\x0b2\x16.types.ArithmeticErrorH\0R\x0farithmeticError\x12G\n\
    \x0freference_error\x18\x04\x20\x01(\x0b2\x1c.types.DynamicReferenceErro\
    rH\0R\x0ereferenceErrorB\x12\n\x10execution_status\"\xe9\x02\n\x08VMStat\
    us\x12;\n\nvalidation\x18\x01\x20\x01(\x0b2\x19.types.VMValidationStatus\
    H\0R\nvalidation\x12E\n\x0cverification\x18\x02\x20\x01(\x0b2\x1f.types.\
    VMVerificationStatusListH\0R\x0cverification\x12S\n\x13invariant_violati\
    on\x18\x03\x20\x01(\x0e2\x20.types.VMInvariantViolationErrorH\0R\x12inva\
    riantViolation\x12>\n\x0fdeserialization\x18\x04\x20\x01(\x0e2\x12.types\
    .BinaryErrorH\0R\x0fdeserialization\x126\n\texecution\x18\x05\x20\x01(\
    \x0b2\x16.types.ExecutionStatusH\0R\texecutionB\x0c\n\nerror_type*\xf8\
    \x03\n\x16VMValidationStatusCode\x12\x1b\n\x17UnknownValidationStatus\
    \x10\0\x12\x14\n\x10InvalidSignature\x10\x01\x12\x12\n\x0eInvalidAuthKey\
    \x10\x02\x12\x18\n\x14SequenceNumberTooOld\x10\x03\x12\x18\n\x14Sequence\
    NumberTooNew\x10\x04\x12(\n$InsufficientBalanceForTransactionFee\x10\x05\
    \x12\x16\n\x12TransactionExpired\x10\x06\x12\x1e\n\x1aSendingAccountDoes\
    NotExist\x10\x07\x12\x14\n\x10RejectedWriteSet\x10\x08\x12\x13\n\x0fInva\
    lidWriteSet\x10\t\x12\x1e\n\x1aExceededMaxTransactionSize\x10\n\x12\x11\
    \n\rUnknownScript\x10\x0b\x12\x11\n\rUnknownModule\x10\x0c\x12&\n\"MaxGa\
    sUnitsExceedsMaxGasUnitsBound\x10\r\x12*\n&MaxGasUnitsBelowMinTransactio\
    nGasUnits\x10\x0e\x12\x1d\n\x19GasUnitPriceBelowMinBound\x10\x0f\x12\x1d\
    \n\x19GasUnitPriceAboveMaxBound\x10\x10*\xc5\x0f\n\x17VMVerificationErro\
    rKind\x12\x1c\n\x18UnknownVerificationError\x10\0\x12\x14\n\x10IndexOutO\
    fBounds\x10\x01\x12\x14\n\x10RangeOutOfBounds\x10\x02\x12\x19\n\x15Inval\
    idSignatureToken\x10\x03\x12\x1c\n\x18InvalidFieldDefReference\x10\x04\
    \x12\x1d\n\x19RecursiveStructDefinition\x10\x05\x12\x18\n\x14InvalidReso\
    urceField\x10\x06\x12\x16\n\x12InvalidFallThrough\x10\x07\x12\x0f\n\x0bJ\
    oinFailure\x10\x08\x12\x20\n\x1cNegativeStackSizeWithinBlock\x10\t\x12\
    \x13\n\x0fUnbalancedStack\x10\n\x12\x20\n\x1cInvalidMainFunctionSignatur\
    e\x10\x0b\x12\x14\n\x10DuplicateElement\x10\x0c\x12\x17\n\x13InvalidModu\
    leHandle\x10\r\x12\x17\n\x13UnimplementedHandle\x10\x0e\x12\x16\n\x12Inc\
    onsistentFields\x10\x0f\x12\x10\n\x0cUnusedFields\x10\x10\x12\x10\n\x0cL\
    ookupFailed\x10\x11\x12\x16\n\x12VisibilityMismatch\x10\x12\x12\x19\n\
    \x15TypeResolutionFailure\x10\x13\x12\x10\n\x0cTypeMismatch\x10\x14\x12\
    \x15\n\x11MissingDependency\x10\x15\x12\x15\n\x11PopReferenceError\x10\
    \x16\x12\x14\n\x10PopResourceError\x10\x17\x12\x1f\n\x1bReleaseRefTypeMi\
    smatchError\x10\x18\x12\x17\n\x13BrTypeMismatchError\x10\x19\x12\x1a\n\
    \x16AbortTypeMismatchError\x10\x1a\x12\x1a\n\x16StLocTypeMismatchError\
    \x10\x1b\x12\x1d\n\x19StLocUnsafeToDestroyError\x10\x1c\x12\x1b\n\x17Ret\
    UnsafeToDestroyError\x10\x1d\x12\x18\n\x14RetTypeMismatchError\x10\x1e\
    \x12\x1e\n\x1aFreezeRefTypeMismatchError\x10\x1f\x12%\n!FreezeRefExistsM\
    utableBorrowError\x10\x20\x12\x20\n\x1cBorrowFieldTypeMismatchError\x10!\
    \x12\x1c\n\x18BorrowFieldBadFieldError\x10\"\x12'\n#BorrowFieldExistsMut\
    ableBorrowError\x10#\x12\x1b\n\x17CopyLocUnavailableError\x10$\x12\x18\n\
    \x14CopyLocResourceError\x10%\x12\x1c\n\x18CopyLocExistsBorrowError\x10&\
    \x12\x1b\n\x17MoveLocUnavailableError\x10'\x12\x1c\n\x18MoveLocExistsBor\
    rowError\x10(\x12\x1b\n\x17BorrowLocReferenceError\x10)\x12\x1d\n\x19Bor\
    rowLocUnavailableError\x10*\x12\x1e\n\x1aBorrowLocExistsBorrowError\x10+\
    \x12\x19\n\x15CallTypeMismatchError\x10,\x12%\n!CallBorrowedMutableRefer\
    enceError\x10-\x12\x19\n\x15PackTypeMismatchError\x10.\x12\x1b\n\x17Unpa\
    ckTypeMismatchError\x10/\x12\x1c\n\x18ReadRefTypeMismatchError\x100\x12\
    \x18\n\x14ReadRefResourceError\x101\x12#\n\x1fReadRefExistsMutableBorrow\
    Error\x102\x12\x1d\n\x19WriteRefTypeMismatchError\x103\x12\x19\n\x15Writ\
    eRefResourceError\x104\x12\x1d\n\x19WriteRefExistsBorrowError\x105\x12#\
    \n\x1fWriteRefNoMutableReferenceError\x106\x12\x1e\n\x1aIntegerOpTypeMis\
    matchError\x107\x12\x1e\n\x1aBooleanOpTypeMismatchError\x108\x12\x1f\n\
    \x1bEqualityOpTypeMismatchError\x109\x12#\n\x1fExistsResourceTypeMismatc\
    hError\x10:\x12!\n\x1dBorrowGlobalTypeMismatchError\x10;\x12\x1f\n\x1bBo\
    rrowGlobalNoResourceError\x10<\x12\x1d\n\x19MoveFromTypeMismatchError\
    \x10=\x12\x1b\n\x17MoveFromNoResourceError\x10>\x12!\n\x1dMoveToSenderTy\
    peMismatchError\x10?\x12\x1f\n\x1bMoveToSenderNoResourceError\x10@\x12\"\
    \n\x1eCreateAccountTypeMismatchError\x10A\x12#\n\x1fModuleAddressDoesNot\
    MatchSender\x10B\x12\x13\n\x0fNoModuleHandles\x10C*\xf7\x01\n\x19VMInvar\
    iantViolationError\x12\"\n\x1eUnknownInvariantViolationError\x10\0\x12\
    \x14\n\x10OutOfBoundsIndex\x10\x01\x12\x14\n\x10OutOfBoundsRange\x10\x02\
    \x12\x13\n\x0fEmptyValueStack\x10\x03\x12\x12\n\x0eEmptyCallStack\x10\
    \x04\x12\x0e\n\nPCOverflow\x10\x05\x12\x0f\n\x0bLinkerError\x10\x06\x12\
    \x17\n\x13LocalReferenceError\x10\x07\x12\x10\n\x0cStorageError\x10\x08\
    \x12\x15\n\x11InternalTypeError\x10\t*\xf9\x01\n\x0bBinaryError\x12\x16\
    \n\x12UnknownBinaryError\x10\0\x12\r\n\tMalformed\x10\x01\x12\x0c\n\x08B\
    adMagic\x10\x02\x12\x12\n\x0eUnknownVersion\x10\x03\x12\x14\n\x10Unknown\
    TableType\x10\x04\x12\x18\n\x14UnknownSignatureType\x10\x05\x12\x19\n\
    \x15UnknownSerializedType\x10\x06\x12\x11\n\rUnknownOpcode\x10\x07\x12\
    \x12\n\x0eBadHeaderTable\x10\x08\x12\x1b\n\x17UnexpectedSignatureType\
    \x10\t\x12\x12\n\x0eDuplicateTable\x10\n*\x86\x03\n\rRuntimeStatus\x12\
    \x18\n\x14UnknownRuntimeStatus\x10\0\x12\x0c\n\x08Executed\x10\x01\x12\
    \x0c\n\x08OutOfGas\x10\x02\x12\x18\n\x14ResourceDoesNotExist\x10\x03\x12\
    \x19\n\x15ResourceAlreadyExists\x10\x04\x12\x18\n\x14EvictedAccountAcces\
    s\x10\x05\x12\x1f\n\x1bAccountAddressAlreadyExists\x10\x06\x12\r\n\tType\
    Error\x10\x07\x12\x0f\n\x0bMissingData\x10\x08\x12\x13\n\x0fDataFormatEr\
    ror\x10\t\x12\x0f\n\x0bInvalidData\x10\n\x12\x13\n\x0fRemoteDataError\
    \x10\x0b\x12\x1f\n\x1bCannotWriteExistingResource\x10\x0c\x12\x1b\n\x17V\
    alueSerializationError\x10\r\x12\x1d\n\x19ValueDeserializationError\x10\
